...
function OrderDetail() {
  const [
    orderState,
    { putPrepareOrder, putDeliveryOrder, putReceiveOrder, putCancelOrder },
  ...
  function refresh() {
    ...
    authInstance
      .get(
        [authConstraints.driverRoot, authConstraints.getAllOrderInfo].join("/"),
        {
          headers: {
            Authorization: [
              ...
              <div>
                <div className="product-label-info">
                  ...
                  <p className="product-content">
                    {"000000".substring(
                      0,
                      6 - result?.order?.id?.toString().length
                    ) + result?.order?.id}
                  </p>
                </div>
                <div className="product-label-info">
                        ...
                        <Form onSubmit={handleSubmit}>
                          <div className="txt-center">
                            ...
                            <p className="order-txt-letter txt-center py-3 px-5">
                              Please send package image when you received it
                              from the sender to start delivery process.
                            </p>
    ...
    <>
      ...
      {stepTemplate[active] === "Cancelled" ? (
        ...
        <div>
                    ...
                    <Formik
                      ...
                      onSubmit={(values) => {
                        const formData = dotnetFormDataSerialize(
                          {
                            ...values,
                            receivedImages: values.receivedImages.map(
                              (item) => item?.file
                            ),
                          },
                          {
          ...
          <div
            className="product-label-info py-3"
