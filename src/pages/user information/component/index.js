...
function UserInformation() {
    ...
    function sendPhoneDigit() {
        ...
        authInstance
            .get(
                [authConstraints.root, authConstraints.sendPhoneDigit].join(
                    "/"
                ),
                {
                    headers: {
            ...
            .then((response) => {
                if (response.data?.successed) {
                    toast.success(
                        "Check your whatsapp to receive confirmation digit"
                    );
                    setLoading(false);
                } else {
                    toast.error("Failed");
    ...
    function confirmPhone(digit) {
        ...
        authInstance
            .get(
                [authConstraints.root, authConstraints.verifiedPhone].join("/"),
                {
                    headers: {
                        Authorization: [
                            config.AuthenticationSchema,
                                    ...
                                    {loading ? (
                                        ...
                                        <div>
                                            ...
                                            <Row>
                                                ...
                                                <Col>
                                                    <p>
                                                        Check new message and
                                                        copy 6-digit code.
                                                        Return website and paste{" "}
