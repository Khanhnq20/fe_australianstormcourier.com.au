...
let rateSchema = yup.object().shape({
  rate: yup
    ...
    .required("Rate is required field"),
});
          ...
          <Col>
            <div className="product-form-info">
              <div>
                ...
                <div className="product-label-info">
                  <p className="product-label">Quality</p>
          ...
          <Col>
            <div>
              ...
              <div className="product-label-info">
                ...
                <p className="content-blue">Looking for a driver</p>
              </div>
              <div
        ...
        <Row>
          <Col>
            <div className="py-4">
              ...
              <div>
                <p>
                  You can get this order fast, enter the price you want to
                  deliver.
                </p>
              </div>
              <div>
                        ...
                        <Form.Group className="form-group">
                          ...
                          <div className="product-rate-form">
                            ...
                            >
                              ...
                              ></div>
                              <div className="eyes-pass px-1">$</div>
                            </div>
                            <div>
    ...
    >
      <div>
        <Modal.Body className="rate-pop-up-ct">
          ...
          <h4>Are you sure?</h4>
          <p className="m-0">Are you sure you want "Cancel delivery request"</p>
        </Modal.Body>
        <Modal.Footer>
          <div style={{ margin: "0 auto" }}>
            <Button
              className="my-btn-red mx-2"
