                    ...
                    <div className="w-100 ban-content-2">
                        <div className="ban-content fadeLeft">
                            <div className="px-4">
                                ...
                                <p className="ban-txt">
                                    Australian Storm Courier is an Australian professional delivery company based in
                                    Melbourne. We provide fast same-day delivery between Dandenong and Melbourne CBD.
                                </p>
                            </div>
                        </div>
                        ...
                        <Row className="del-row">
                            <Col className="col-12 col-md-6">
                                <div>
                                    <div>
                                        <img
                                            className={`del-img img-auto-flex ${inView ? 'fadeLeft' : ''}`}
                                            src={gps}
                                        />
                                    </div>
                                </div>
                            ...
                            <Col className="del-content py-4">
                                ...
                                <p>
                                    You decide your own rates and dates and our drivers can accept your jobs or offer a
                                    different rate. We offer you the flexibility to choose your favourite drivers and
                                    rates.
                                </p>
                    ...
                    <div className="container">
                        <Row>
                            <Col className="del-content py-4">
                                ...
                                <p>
                                    We offer job flexibility and choice. You get to decide what jobs are best suited for
                    ...
                    <div className="container py-4">
                        <Row>
                            <Col className="py-4">
                                ...
                                <p className="mar-txt">
                                    Need to send something on time? Contact us now. Over 100 businesses trust Australian
                                    Storm Courier. Whether it’s small parcels or large pallets, we’re here for you
                                    anytime to get these shipments where they need to be.
                                </p>
                            </Col>
                        </Row>
                        <Row>
                                ...
                                <div className="mar-item">
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <p>
                                                We specialize in same-day delivery, door-to-door express shipping,
                                                contactless, and pickups.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mar-item mb-4">
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <p>
                                                Both you and your customers have full visibility on your parcels
                                                location from pickup right through to delivery.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mar-item">
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <p>
                                                With us, you will get the most reputable and quality service at a very
                                                reasonable price.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="mar-item">
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <p>
                                                Whether you’re just starting out or already in business, our mission is
                ...
                <div className="cus-root" ref={ref}>
                    <div className="container px-4 py-5">
                        <div className={`pb-4 ${inView ? 'fadeDown' : ''}`}>
                            ...
                            <p className="mar-txt">
                                When you are a customer, you can send your package quickly. When you are a driver, you
                                can receive many orders in a day.
                            </p>
                        </div>
