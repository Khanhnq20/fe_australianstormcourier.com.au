          ...
          <div className="w-100 ban-content-2">
            <div className="ban-content fadeLeft">
              <div className="px-4">
                ...
                <h3 className="ban-txt-header py-3">
                  GPS Postal <br />
                  Tracking
                </h3>

                <p className="ban-txt">
                  Australian Storm Courier is an Australian professional
                  delivery company based in Melbourne. We provide fast same-day
                  delivery between Dandenong and Melbourne CBD.
                </p>
              </div>
            </div>
          ...
          <div className="container">
            <Row>
              <Col className="del-content py-4">
                ...
                <p>
                  If you need assistance with parcel deliveries, we can help! We
                  can assist with deliveries of all sizes whether personal or
                  business related. AS Courier provides package delivery and
                  same-day courier services within each city in Australia. We
                  cater to households and businesses; specialising in providing
                  final mile delivery solutions for eCommerce businesses and
                  online traders.
                </p>
              ...
              <Col className="col-12 col-md-6">
                <div>
                  <div>
                    <img
                      className={`del-img img-auto-flex${
                        inView ? " fadeRight" : ""
                      }`}
                      src={shipping}
                    />
          ...
          <div className="container">
            <Row className="del-row">
              ...
              <Col className="del-content py-4">
                ...
                <p>
                  You decide your own rates and dates and our drivers can accept
                  your jobs or offer a different rate. We offer you the
                  flexibility to choose your favourite drivers and rates.
                </p>
      ...
      {({ inView, ref }) => (
        <div className="del-root" ref={ref}>
          <div className="container">
            <Row>
              <Col className="del-content py-4">
                <h3 className="card-header py-4">
                  WHY DRIVER FOR AUSTRALIAN STORM COURIER?
                </h3>
                <p>
                  We offer job flexibility and choice. You get to decide what
                  jobs are best suited for you, and get paid for it! At
                  Australian Storm Courier, we understand the importance of a
          ...
          <div className="container py-4">
            <Row>
              <Col className="py-4">
                ...
                <p className="mar-txt">
                  Need to send something on time? Contact us now. Over 100
                  businesses trust Australian Storm Courier. Whether it’s small
                  parcels or large pallets, we’re here for you anytime to get
                  these shipments where they need to be.
                </p>
              </Col>
            </Row>
            <Row>
                ...
                <div className="mar-item">
                  ...
                  <div>
                    <div>
                      ...
                      <p>
                        We specialize in same-day delivery, door-to-door express
                        shipping, contactless, and pickups.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <Col sm="12" lg="6" className={inView ? "fadeLeft" : ""}>
                <div className="mar-item mb-4">
                  ...
                  <div>
                    <div>
                      <h4>GPS Postal Tracking</h4>
                      <p>
                        Both you and your customers have full visibility on your
                        parcels location from pickup right through to delivery.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <Col sm="12" lg="6" className={inView ? "fadeLeft-slower" : ""}>
                <div className="mar-item">
                  ...
                  <div>
                    <div>
                      <h4>Saving Your Money</h4>
                      <p>
                        With us, you will get the most reputable and quality
                  ...
                  <div>
                    <div>
                      ...
                      <p>
                        ...
                        our mission is to help you make the most of your
                        precious time.
                      </p>
                    </div>
                  </div>
        ...
        <div className="cus-root" ref={ref}>
          <div className="container px-4 py-5">
            <div className={`pb-4 ${inView ? "fadeDown" : ""}`}>
              <h3 className="mar-txt-header">
                YOU CAN QUICKLY BECOME A CUSTOMER OR DRIVER.
              </h3>
              <p className="mar-txt">
                When you are a customer, you can send your package quickly. When
                you are a driver, you can receive many orders in a day.
              </p>
            </div>
