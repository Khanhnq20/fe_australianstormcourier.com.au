        ...
        <div>
          <div className="driver-form container">
            <div className="product-label-info">
              <p className="product-label">Driver Name</p>
            ...
            <div className="product-label-info">
              <p className="product-label">Has Inspected</p>
              <p className="product-content">
            ...
            <div className="product-label-info">
              ...
              <p className="product-content">{authState?.accountInfo?.city}</p>
            </div>
            <div className="product-label-info">
              <p className="product-label">Confirm Driving License</p>
              <p className="product-content">
                {authState?.accountInfo?.drivingLicenseConfirm ? (
                  <span>Confirmed</span>
                ) : (
...
export default function Index() {
  return <DriverDetail></DriverDetail>;
}
