...
function RegisterDriver() {
    ...
    return (
        ...
        >
        {({touched, errors, handleSubmit, handleChange, handleBlur, setFieldValue, isValid, values}) =>{
            return( 
                <div>
                                ...
                                <Form className='reg-form' onSubmit={handleSubmit}>
                                    ...
                                    <Form.Group className="form-group" >
                                        ...
                                        <div className='front-up'>
                                            ...
                                            <input type="file" id="driver_image_front" name="frontDrivingLiense" 
                                                ...
                                                return(
                                                    <div key={index}>
                                                        <label class="fr-checkbox mb-2">
                                                            <input type="checkbox" name="vehicles" value={item?.id} onChange={handleChange}/>
...
//             <Dropdown.Menu className='w-100' onChange={(e) =>{
//             }}>
