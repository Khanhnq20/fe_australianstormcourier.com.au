...
export default function Index() {
  ...
  useEffect(() => {
    ...
    if (paymentId) {
      authInstance
        .get(
          [authConstraints.userRoot, authConstraints.getSinglePayment].join(
            "/"
          ),
          {
            headers: {
  ...
  if (allowed && options.clientSecret)
    return (
        ...
        <div className="invoice-form" ref={componentRef}>
          <div className="invoice-header">
            <div style={{ maxWidth: "100px", marginBottom: "20px" }}>
              <img
                src="https://australianstormcourier.com.au/wp-content/uploads/2023/04/as-logo.png"
                width="100%"
              />
            </div>
            <div>
              <p className="invoice-txt-header">
          ...
          <div style={{ margin: "0 auto" }}>
            <div style={{ display: "flex", gap: "30px" }}>
              ...
              <div>
                ...
                <div className="invoice-txt-content">
                  +{payment?.sender?.phoneNumber}
                </div>
              </div>
            </div>
            <div
              style={{ width: "auto", overflow: "hidden", marginTop: "20px" }}
            >
                ...
                <tbody>
                  <tr>
                    <td>
                      ...
                      <p>
                        From:{" "}
                        {Object.entries(payment?.order?.sendingLocation)
                          .map(([_, v]) => v)
                          .join(", ")}
                      </p>
