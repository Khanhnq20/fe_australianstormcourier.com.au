...
function ProductDetail() {
  ...
  const {
    ...
    fetchingAPIInstance: ({ controller, page, take }) =>
      authInstance.get(
        [authConstraints.userRoot, authConstraints.getOrderOffers].join("/"),
        {
          headers: {
            Authorization: [
  ...
  function getOrderInfo() {
    ...
    authInstance
      .get(
        [authConstraints.userRoot, authConstraints.getAllOrderInfo].join("/"),
        {
          headers: {
            Authorization: [
              config.AuthenticationSchema,
  ...
  function acceptDriver(driverId) {
    ...
    authInstance
      .put(
        [authConstraints.userRoot, authConstraints.acceptDriverOffer].join("/"),
        null,
        {
          headers: {
            Authorization: [
  ...
  function cancelDriver(driverId) {
    ...
    authInstance
      .put(
        [authConstraints.userRoot, authConstraints.cancelDriverOffer].join("/"),
        null,
        {
          headers: {
            Authorization: [
  ...
  function createOrderPayment(orderId, driverId) {
    ...
    return authInstance
      .post(
        [
          authConstraints.userRoot,
          authConstraints.postCheckoutIntentSessions,
        ].join("/"),
        null,
        {
          headers: {
              ...
              <div>
                <div className="product-label-info">
                  ...
                  <p className="product-content">
                    {"000000".substring(0, 6 - order?.id?.toString().length) +
                      order?.id}
                  </p>
                </div>
                <div className="product-label-info">
                ...
                <div className="product-label-info">
                  ...
                  <p className="product-content">
                    {new moment(order?.createdDate).format(
                      "YYYY-MM-DD HH : mm : ss"
                    )}
                  </p>
                </div>
                ...
                <div>
                  ...
                  >
                    <div className="background-front">
                      ...
                      >
                        {order?.deliverdItemImages?.split("[space]")?.length ||
                          0}
                      </div>
                    ...
                    <div>
                      ...
                      >
                        <div className="background-front">
                          ...
                          >
                            {
                              order?.orderItems?.[0]?.itemImages?.split(
                                "[space]"
                              )?.length
                            }
                          </div>
        ...
        <div className="py-4">
          ...
          <div>
            <p style={{ fontWeight: "600" }}>
              The driver requested {order?.offerNumber} offers
            </p>
          </div>
                  ...
                  {offers?.map?.((offer, index) => {
                    return (
                      <tr key={index}>
                        ...
                        <td>
                          {new moment(offer?.createdDate).format("DD/MM/YYYY")}
                        </td>
                        <td>
...
let productSchema = yup.object().shape({
  shippingRates: yup
    .string()
    .required("Selected shipper rates is required field"),
  phoneNumber: yup
    .number()
                    ...
                    <div className="form-order">
                      ...
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          isInvalid={
                            touched.shippingRates && errors.shippingRates
                          }
                          onChange={handleChange}
                          onBlur={handleBlur}
                        />
  ...
  return (
    <Dropdown className="reg-dr">
      ...
      <Dropdown.Menu className="w-100">
        <Dropdown.Item onClick={() => setState(true)}>
          Looking for driver
        </Dropdown.Item>
    ...
    <div>
      ...
      <div className="product-label-info py-3" style={{ alignItems: "unset" }}>
        ...
        <div>
          ...
          <Modal
            centered
            show={modalDeliveryImage}
            onHide={() => setModalDeliveryImage(false)}
          >
