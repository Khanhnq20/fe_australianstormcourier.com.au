    ...
    <>
      <Container className="pt-4 text-center">
        ...
        <p className="text-center">
          This page are being modified or not existed now.{" "}
          <b style={{ color: "var(--clr-primary)" }}>Come back</b> to your
          previous page
        </p>
      </Container>
    </>
  ...
  return (
    <>
      <Container className="pt-4 text-center">
        ...
        <p className="text-center">
          Your request is not capable to the content of page.{" "}
          <b style={{ color: "var(--clr-primary)" }}>Come back</b> to your
          previous page
        </p>
      </Container>
  ...
  return (
    <>
      <Container className="pt-4 text-center">
        ...
        <p>
          Sorry for this inconvenience. We are working on the best to bring
          service back to you.
        </p>
        <p>
