...
function DriverList() {
  ...
  const {
    ...
    fetchingAPIInstance: ({ controller, page, take }) =>
      authInstance.get(
        [authConstraints.adminRoot, authConstraints.getAccountsDriver].join(
          "/"
        ),
        {
          headers: {
  ...
  function acceptDriver(driverId) {
    ...
    authInstance
      .post(
        [authConstraints.adminRoot, authConstraints.acceptAccountDriver].join(
          "/"
        ),
        null,
        {
  ...
  function blockDriver(driverId) {
    ...
    authInstance
      .put(
        [authConstraints.adminRoot, authConstraints.blockAccount].join("/"),
        null,
        {
          headers: {
            Authorization: [
            ...
            {!driver?.isAusDrivingLiense && (
              <div className="product-label-info">
                ...
                <a
                  ...
                  href={driver?.drivingCertificate}
                  target="_blank"
                >
                  View Pdf
                </a>
