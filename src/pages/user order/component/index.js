                ...
                <div>
                    <div className='p-3'>
                        <Form onSubmit={handleSubmit}>
                            ...
                            <Button type='submit' variant="warning" style={{backgroundColor:"#f2a13b",border:'none'}} className={`my-btn-yellow my-4 product-btn-search`}>
                            ...
                            <div>
                                <Dropdown className='reg-dr' style={{width:'fit-content'}}>
                                    ...
                                    <Dropdown.Menu>
                                        {rows.map((item,index) => {
                                            return(
                                                <Dropdown.Item key={index + 1} onClick={()=>setPerPageAmount(item)}>{item}</Dropdown.Item>
                                            )
                                        })}
                                    </Dropdown.Menu>
                                </Dropdown>
