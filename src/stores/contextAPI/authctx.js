...
export default function Index({ children }) {
  ...
  const funcs = {
    ...
    signupUser(body, returnURL = "", callback) {
      ...
      authInstance
        .post(
          [authConstraints.root, authConstraints.signupUser].join("/"),
          body,
          {
            params: {
        ...
        .then((response) => {
          if (response.data?.successed) {
            toast.success(
              `You have registered account successfully, please goto "Signin" to join us`,
              {}
            );
            callback?.();
            setState((i) => ({
    ...
    signupDriver(body, returnURL = "", callback) {
      ...
      authInstance
        .post(
          [authConstraints.root, authConstraints.signupDriver].join("/"),
          body,
          {
            params: {
              returnURL: encodeURIComponent(returnURL),
        ...
        .then((response) => {
          setState((i) => ({
            ...i,
            errors: [
              ...response.data?.registeredErrors,
              ...response.data?.assingedToRoleErrors,
            ],
            tasks: {
              ...i.tasks,
  ...
  const accountActions = {
    updateProfile(body) {
      ...
      return authInstance
        .post(
          [authConstraints.root, authConstraints.updateUser].join("/"),
          body,
          {
            // params: {
            //     userId
    ...
    updateDriverProfile(body) {
      ...
      return authInstance
        .post(
          [authConstraints.root, authConstraints.updateDriver].join("/"),
          body,
          {
            headers: {
              Authorization: [
