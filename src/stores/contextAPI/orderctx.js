...
export default function Index({ children }) {
  ...
  const funcs = {
    getJobAvailables() {
      ...
      return authInstance
        .get(
          [authConstraints.driverRoot, authConstraints.getDriverJobs].join(" "),
          {
            headers: {
              Authorization: [
    ...
    postOrder(body) {
      ...
      authInstance
        .post(
          [authConstraints.userRoot, authConstraints.postOrder].join("/"),
          body,
          {
            headers: {
              Authorization: [
    ...
    postDriverOffer(body) {
      ...
      return authInstance
        .post(
          [authConstraints.driverRoot, authConstraints.postDriverOffers].join(
            "/"
          ),
          body,
          {
    ...
    putCancelOffer(orderId) {
      ...
      authInstance
        .put(
          [authConstraints.driverRoot, authConstraints.putCancelOffer].join(
            "/"
          ),
          null,
          {
    ...
    putPrepareOrder(body) {
      ...
      authInstance
        .put(
          [authConstraints.driverRoot, authConstraints.putPrepareOrder].join(
            "/"
          ),
          body,
          {
    ...
    putDeliveryOrder(orderId) {
      ...
      authInstance
        .put(
          [authConstraints.driverRoot, authConstraints.putDeliverOrder].join(
            "/"
          ),
          null,
          {
    ...
    putReceiveOrder(body) {
      ...
      authInstance
        .put(
          [authConstraints.driverRoot, authConstraints.putReceiveOrder].join(
            "/"
          ),
          body,
          {
