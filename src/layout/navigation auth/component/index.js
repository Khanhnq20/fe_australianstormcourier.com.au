                ...
                <div className="notify-form-content">
                    ...
                    <div>
                        <p>
                            ...
                            sensible breakpoints for our layouts and interfaces.
                        </p>
                    </div>
                </div>
            </div>
...
function AvatarUserDropDown() {
    ...
    const [{ accountInfo }, { signout }] = useContext(AuthContext);
        ...
        <div className="mx-4">
            <div className="nav-avatar" onClick={() => setShow((e) => !e)}>
                ...
                <div className="user-name">
                    <div>
                        <p className="content-green" style={{ display: 'block', margin: 0 }}>
                            {accountInfo?.roles?.[0]}
                        </p>
                        <p className="pt-1" style={{ color: '#666666', margin: '0', paddingLeft: '10px' }}>
            ...
            {show ? (
                <div className="nav-menu">
                    ...
                    <div className="nav-menu-topic" onClick={() => setShow((e) => !e)}>
                        ...
                        <Link
                            to={
                                accountInfo?.roles?.includes('Driver')
                                    ? `driver/password`
                                    : accountInfo?.roles?.includes('User')
                                    ? `/user/password`
                                    : `/admin/password`
                            }
                            style={{
                    ...
                    <div className="nav-menu-topic" onClick={signout}>
                        ...
                        <div onClick={() => setShow((e) => !e)}>Log out</div>
                    </div>
                </div>
            ) : (
                <></>
